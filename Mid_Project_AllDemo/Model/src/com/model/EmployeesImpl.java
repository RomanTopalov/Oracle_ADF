...
public class EmployeesImpl extends EntityImpl {
    ...
    public void remove() {
        ...
        System.out.println("we don't allow to remove Employees");
        //        super.remove();
    }
     ...
     */
    public boolean validateHotEmail(String email) {
        
        if(email.endsWith("hot.com")){
            return false;
            }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.model.Employees");
    }
